...
import { HomeIcon, BookOpenIcon, HelpCircleIcon, GraduationCapIcon, UsersIcon, HeartIcon, SunIcon, MenuIcon, XIcon, SparklesIcon, CheckSquareIcon, CalendarIcon, ShieldIcon, BabyIcon, PlayIcon, BookIcon, MessageCircleIcon } from 'lucide-react';
...
export function Dashboard({
  ...
  const navItems = userType === 'engaged' ? [{
    ...
    icon: <MessageCircleIcon className="h-5 w-5 ml-3" />
  }] : [{
    id: 'cards',
    label: 'بطاقات معرفية',
