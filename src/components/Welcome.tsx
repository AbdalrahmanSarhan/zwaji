      ...
      <div className="max-w-4xl mx-auto relative">
        ...
        <div className="mb-12 animate-fadeIn animation-delay-300">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <button onClick={() => onSelectUserType('husband')} className="group relative bg-white hover:bg-sky-50 border-2 border-sky-200 rounded-lg p-8 shadow-md transition duration-300 transform hover:-translate-y-1 hover:shadow-lg overflow-hidden">
            ...
            <button onClick={() => onSelectUserType('wife')} className="group relative bg-white hover:bg-rose-50 border-2 border-rose-200 rounded-lg p-8 shadow-md transition duration-300 transform hover:-translate-y-1 hover:shadow-lg overflow-hidden">
            ...
            <button onClick={() => onSelectUserType('engaged')} className="group relative bg-white hover:bg-purple-50 border-2 border-purple-200 rounded-lg p-8 shadow-md transition duration-300 transform hover:-translate-y-1 hover:shadow-lg overflow-hidden">
            ...
            <button onClick={() => onSelectUserType('both')} className="group relative bg-white hover:bg-amber-50 border-2 border-amber-200 rounded-lg p-8 shadow-md transition duration-300 transform hover:-translate-y-1 hover:shadow-lg overflow-hidden">
